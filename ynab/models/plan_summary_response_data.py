...
class PlanSummaryResponseData(BaseModel):
    ...
    default_budget: Optional[PlanSummary] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "budgets": [PlanSummary.from_dict(_item) for _item in obj["budgets"]] if obj.get("budgets") is not None else None,
            "default_budget": PlanSummary.from_dict(obj["default_budget"]) if obj.get("default_budget") is not None else None
        })
        return _obj
