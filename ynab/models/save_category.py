...
class SaveCategory(BaseModel):
    ...
    goal_target: Optional[StrictInt] = Field(default=None, description="The goal target amount in milliunits format.  This amount can only be changed if the category already has a configured goal (goal_type != null).")
    __properties: ClassVar[List[str]] = ["name", "note", "category_group_id", "goal_target"]
